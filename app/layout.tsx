  ...
  return (
    <html lang="en" className="h-full">
      <head>
        ...
        <link
          href="https://fonts.googleapis.com/css2?family=Cormorant+Garamond:ital,wght@0,300;0,400;0,500;0,600;0,700;1,400;1,600&family=Amiri:ital,wght@0,400;0,700;1,400&family=Inter:wght@300;400;500&family=Lora:wght@400;500;600&display=swap"
          rel="stylesheet"
        />
      </head>
